-- Migration: 20260508_complete_checkout_payment.sql
-- Purpose: Persist explicit payment completion fields for POS checkout transactions.
...
alter table if exists public.transactions
  ...
  check (payment_status in ('COMPLETED', 'REFUNDED', 'VOIDED'));
